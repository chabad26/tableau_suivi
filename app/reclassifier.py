...
from app.classifier import detect_status
...
def reclassify_emails() -> ReclassifyResult:
    """
    Réanalyse les emails archivés dans SQLite.

    Les messages sans corps enregistré sont comptés comme manquants.
    """
    ...
    for row in rows:
        ...
        status_changed, _, _ = reanalyse_email(
